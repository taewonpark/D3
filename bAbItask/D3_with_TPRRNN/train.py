...
parser.add_argument('-code_size', type=int, default=64, help='')
parser.add_argument('-n_keys', type=int, default=64, help='')
parser.add_argument('-top_k', type=int, default=8, help='')
...
parser.add_argument('-log_dir', type=str, default='D3', help='directory to store log data')
